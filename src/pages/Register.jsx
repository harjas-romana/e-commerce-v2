...
const Register = () => {
  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <div className="auth-panel">
          <div className="auth-panel-inner">
            <p className="auth-panel-eyebrow">New here?</p>
            <h2 className="auth-panel-headline">Start your<br />journey.</h2>
            <p className="auth-panel-body">
              Create an account to track orders, save favourites, and enjoy a seamless checkout every time.
            </p>
          </div>
      ...
      {/* Shared styles (identical to Login — move to global CSS in production) */}
      <style>{`
        .auth-page {
        ...
        .auth-panel-deco { position: absolute; bottom: -60px; right: -60px; z-index: 0; }
